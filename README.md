...
- FastAPI app setup and static file mounting in `backend/main.py`.
- The product catalog page route in `backend/catalog.py`.
- Async DummyJSON API requests in `backend/product_service.py`.
...
- The JavaScript in `frontend/static/app.js` only toggles the gallery row.
